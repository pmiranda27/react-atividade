...
import TituloProdutos from './components/Title';
...
function App() {
  ...
  return (
    <div className='tela-principal'>
      <TituloProdutos>Lista de Produtos Beta</TituloProdutos>
      <Description>Aqui temos uma grande lista de produtos, sobre produtos. Aproveite!</Description>
      <div className='ListaDiv'>
        <ListaProdutos lista={listaProdutos}></ListaProdutos>
      </div>
    </div>
  );
}
